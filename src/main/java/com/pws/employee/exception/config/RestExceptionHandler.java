...
import com.pws.employee.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handles Wealth Junction Generic Exception. Created to encapsulate errors with
	 * more details.
	 *
	 * @param ex the WealthJunctionException
	 * @return the ApiError object
	 */
	@ExceptionHandler(PWSException.class)
	protected ResponseEntity<Object> handlePWSException(PWSException ex) {
		ApiError apiError = new ApiError(BAD_REQUEST);
		apiError.setMessage(ex.getMessage());
		return buildResponseEntity(apiError);
	}
